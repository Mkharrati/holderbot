...
## install
```
sudo bash c "$(curl -sL https://github.com/Mkharrati/holderbot/raw/main/holderbot.sh)"
```
## restart
```
sudo bash -c "$(curl -sL https://github.com/Mkharrati/holderbot/raw/main/restart.sh)"
```
## uninstall
```
sudo bash -c "$(curl -sL https://github.com/Mkharrati/holderbot/raw/main/uninstall.sh)"
```
