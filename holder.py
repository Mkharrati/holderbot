    ...
    if DEF_CHECK_BOSS(MESSAGE_CHATID):
        ...
        if CHECK_STEP == "None" :
            ...
            if MESSAGE_TEXT == "/start" :
                TEXT = "<b>Hello boss,I'm HolderBot (version 4.7.0)\n\nI am an open-source Telegram bot designed to provide unique and special features. All my commands are clear, but you can still refer to the <a href='https://github.com/Mkharrati/holderbot/wiki'>Wiki</a> for tutorials and guidance, open an <a href='https://github.com/Mkharrati/holderbot/issues'>issue</a> for bugs and suggestions, and join the <a href='https://t.me/ErfjabHolderbot'>channel</a> for important news.\n\nBy the way, boss, to enhance my capabilities, you can help my developer by forking the project on GitHub. Even if you're not familiar with coding, you can still contribute by <a href='https://github.com/Mkharrati/holderbot'>starring</a> the project. Either way, thank you.</b>"
                ...
                TEXT = "<b>Hello boss, It seems you've encountered an issue! Don't worry, first check the <a href='https://github.com/Mkharrati/holderbot/wiki'>Github Wiki</a> or <a href='https://t.me/ErfjabHolderbot'>Telegram channel</a>. If your problem persists, open an <a href='https://github.com/Mkharrati/holderbot/issues'>issue on Github</a> so that my developer can respond to you promptly.\n\nAdditionally, a file containing my logs has been sent to you, which my developer needs for debugging and resolving the issue. Thank you for your cooperation, boss.</b>"
                await client.send_message(chat_id=MESSAGE_CHATID , text=TEXT , reply_markup=KEYBOARD_HOME , parse_mode=enums.ParseMode.HTML , disable_web_page_preview=True)
